...
CONTEXT_RESERVED_OUTPUT_TOKENS = int(os.getenv("CONTEXT_RESERVED_OUTPUT_TOKENS", "4096"))
CONTEXT_TOKENIZER_MODEL = os.getenv("CONTEXT_TOKENIZER_MODEL", "")
CONTEXT_COMPACT_TOKEN_THRESHOLD_PERCENT = int(os.getenv("CONTEXT_COMPACT_TOKEN_THRESHOLD_PERCENT", "80"))
...
CLI_ESC_CANCEL = os.getenv("CLI_ESC_CANCEL", "true").lower() in {"1", "true", "yes", "y"}
